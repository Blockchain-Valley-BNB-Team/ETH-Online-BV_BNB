...
export declare namespace ResearchRegistry {
  export type ResearchResultStruct = {
  ...
  export type ResearchResultStructOutput = [
    researcher: string,
    resultData: string,
    timestamp: bigint,
    sessionId: string,
  ] & { researcher: string; resultData: string; timestamp: bigint; sessionId: string };
}
...
export interface ResearchRegistry extends BaseContract {
  ...
  getResearchCount: TypedContractMethod<[_researcher: AddressLike], [bigint], "view">;

  researchCount: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "getLatestResearch",
  ): TypedContractMethod<[_researcher: AddressLike], [ResearchRegistry.ResearchResultStructOutput], "view">;
  getFunction(
    nameOrSignature: "getResearch",
  ): TypedContractMethod<
    [_researcher: AddressLike, _researchId: BigNumberish],
    [ResearchRegistry.ResearchResultStructOutput],
    "view"
  >;
  getFunction(nameOrSignature: "getResearchCount"): TypedContractMethod<[_researcher: AddressLike], [bigint], "view">;
  getFunction(nameOrSignature: "researchCount"): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  getFunction(
    nameOrSignature: "researchResults",
  ): TypedContractMethod<
    [arg0: AddressLike, arg1: BigNumberish],
    [
      [string, string, bigint, string] & {
  ...
  >;
  getFunction(
    nameOrSignature: "storeResearch",
  ): TypedContractMethod<[_researcher: AddressLike, _resultData: string, _sessionId: string], [bigint], "nonpayable">;

  getEvent(
    key: "ResearchStored",
  ): TypedContractEvent<
    ResearchStoredEvent.InputTuple,
    ResearchStoredEvent.OutputTuple,
    ResearchStoredEvent.OutputObject
  >;

  filters: {
    "ResearchStored(address,uint256,string,uint256)": TypedContractEvent<
      ResearchStoredEvent.InputTuple,
      ResearchStoredEvent.OutputTuple,
      ResearchStoredEvent.OutputObject
    >;
    ResearchStored: TypedContractEvent<
      ResearchStoredEvent.InputTuple,
      ResearchStoredEvent.OutputTuple,
      ResearchStoredEvent.OutputObject
    >;
