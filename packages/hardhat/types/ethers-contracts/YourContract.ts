...
export interface YourContractInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "totalCounter", values?: undefined): string;
  encodeFunctionData(functionFragment: "userGreetingCounter", values: [AddressLike]): string;
  ...
  decodeFunctionResult(functionFragment: "totalCounter", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "userGreetingCounter", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "withdraw", data: BytesLike): Result;
}

export namespace GreetingChangeEvent {
  export type InputTuple = [greetingSetter: AddressLike, newGreeting: string, premium: boolean, value: BigNumberish];
  export type OutputTuple = [greetingSetter: string, newGreeting: string, premium: boolean, value: bigint];
...
export interface YourContract extends BaseContract {
  ...
  userGreetingCounter: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;

  withdraw: TypedContractMethod<[], [void], "nonpayable">;

  getFunction<T extends ContractMethod = ContractMethod>(key: string | FunctionFragment): T;

  getFunction(nameOrSignature: "greeting"): TypedContractMethod<[], [string], "view">;
  getFunction(nameOrSignature: "owner"): TypedContractMethod<[], [string], "view">;
  getFunction(nameOrSignature: "premium"): TypedContractMethod<[], [boolean], "view">;
  getFunction(nameOrSignature: "setGreeting"): TypedContractMethod<[_newGreeting: string], [void], "payable">;
  getFunction(nameOrSignature: "totalCounter"): TypedContractMethod<[], [bigint], "view">;
  getFunction(nameOrSignature: "userGreetingCounter"): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
